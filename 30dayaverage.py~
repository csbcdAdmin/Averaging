__author__ = "Reed Shinsato"
__credits__ = ["Reed Shinsato", "Christian A. Damo"]
"""
This script does simple averaging for a given set of data.
It fills in the missing data by a set FREQUENCY and takes the average of the data of length specified by a MAGICNUMBER. 
"""
